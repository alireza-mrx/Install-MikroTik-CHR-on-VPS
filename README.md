...
```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/alireza-mrx/Install-MikroTik-CHR-on-VPS/main/mik-6486.sh)"
```

For MikroTik 7.10.2

```bash
  bash -c "$(curl -L https://raw.githubusercontent.com/alireza-mrx/Install-MikroTik-CHR-on-VPS/main/mik78.sh)"
```
